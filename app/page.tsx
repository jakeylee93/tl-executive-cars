      ...
      <section id="fleet" className="py-20 md:py-28 bg-gradient-to-b from-gray-50 to-white border-t border-black/5 overflow-hidden">
        ...
        <div className="mt-12 text-center px-6">
          ...
          <div className="flex items-center justify-center gap-5 flex-wrap">
            {/* Visa */}
            <svg viewBox="0 0 48 32" className="h-8 w-auto"><rect width="48" height="32" rx="4" fill="#1a1f71"/><path d="M19.5 21h-3l1.9-10h3l-1.9 10zm12.4-9.7c-.6-.2-1.5-.5-2.7-.5-3 0-5.1 1.5-5.1 3.7 0 1.6 1.5 2.5 2.6 3.1 1.2.6 1.5.9 1.5 1.4 0 .8-.9 1.1-1.8 1.1-1.2 0-1.8-.2-2.8-.6l-.4-.2-.4 2.5c.7.3 2 .6 3.3.6 3.2 0 5.2-1.5 5.2-3.8 0-1.3-.8-2.2-2.5-3-1-.5-1.7-.9-1.7-1.4 0-.5.5-1 1.7-1 1 0 1.7.2 2.2.4l.3.1.4-2.4zm7.9-.3h-2.3c-.7 0-1.3.2-1.6.9l-4.4 10.1h3.2s.5-1.4.6-1.7h3.8c.1.4.4 1.7.4 1.7h2.8l-2.5-11zm-3.7 7.1c.2-.6 1.2-3.1 1.2-3.1s.2-.7.4-1.1l.2 1s.6 2.7.7 3.2h-2.5zM17.2 11l-2.8 6.8-.3-1.5c-.5-1.7-2.1-3.6-3.9-4.5l2.7 9.2h3.2l4.8-10h-3.7z" fill="#fff"/><path d="M12.1 11H7.1l-.1.3c3.8.9 6.3 3.2 7.3 5.9l-1.1-5.3c-.2-.7-.7-.9-1.1-.9z" fill="#f9a51a"/></svg>
            {/* Mastercard */}
            <svg viewBox="0 0 48 32" className="h-8 w-auto"><rect width="48" height="32" rx="4" fill="#252525"/><circle cx="19" cy="16" r="9" fill="#eb001b"/><circle cx="29" cy="16" r="9" fill="#f79e1b"/><path d="M24 9.3a9 9 0 0 0-3.4 6.7 9 9 0 0 0 3.4 6.7 9 9 0 0 0 3.4-6.7 9 9 0 0 0-3.4-6.7z" fill="#ff5f00"/></svg>
            {/* Amex */}
            <svg viewBox="0 0 48 32" className="h-8 w-auto"><rect width="48" height="32" rx="4" fill="#016fd0"/><path d="M6 16.5l1.2-2.8h2.5l.7 1.5.7-1.5h9.7l.8 1 .8-1H27l1.2 2.8-1.2 2.8h-4.7l-.8-1-.9 1h-3.8l-.4-.9h-.9l-.4.9H12l-.7-1.5-.7 1.5H6l1.2-2.8zm4 1.7h1l.5-1.1.5 1.1h4.3l-1.5-1.7 1.5-1.7h-4.1l-.5 1.1-.5-1.1H10l1.5 1.7L10 18.2zm14.5 0h1.8l-2-2.3v-.9h3.7v1.1h-2.3l2 2.3v.8h-3.8l.6-1z" fill="#fff"/></svg>
            {/* Apple Pay */}
            <svg viewBox="0 0 48 32" className="h-8 w-auto"><rect width="48" height="32" rx="4" fill="#000"/><path d="M15.2 11.8c-.4.5-1 .9-1.6.8-.1-.6.2-1.3.5-1.7.4-.5 1-.8 1.5-.8.1.6-.2 1.2-.4 1.7zm.4.9c-.9 0-1.6.5-2 .5s-1-.5-1.7-.5c-.9 0-1.7.5-2.1 1.2-.9 1.5-.2 3.8.6 5.1.4.6.9 1.3 1.6 1.3.6 0 .9-.4 1.6-.4.7 0 .9.4 1.6.4s1.1-.7 1.5-1.3c.5-.7.7-1.4.7-1.4-.8-.3-1-1.1-1-2.1 0-.8.4-1.5.9-1.9-.5-.7-1.3-1-2.1-.9h-.1zm7.1-.7v7.9h1.2v-2.7h1.7c1.5 0 2.6-1 2.6-2.6s-1-2.6-2.5-2.6h-3zm1.2 1h1.4c1 0 1.6.6 1.6 1.5 0 1-.6 1.6-1.6 1.6h-1.4V13zm6.6 7c.8 0 1.5-.4 1.8-1h0v.9h1.1v-3.9c0-1.1-.9-1.9-2.3-1.9-1.2 0-2.2.7-2.2 1.8h1.1c.1-.6.6-.9 1.1-.9.7 0 1.2.4 1.2 1v.4l-1.5.1c-1.4.1-2.2.7-2.2 1.7 0 1.1.8 1.8 1.9 1.8zm.3-.9c-.6 0-1-.3-1-1 0-.5.4-.9 1.2-1l1.4-.1v.5c0 .9-.7 1.6-1.6 1.6zm4.1 2.8c1.1 0 1.7-.4 2.1-1.6l2-5.6h-1.2l-1.3 4.3h0l-1.3-4.3h-1.3l1.9 5.3-.1.3c-.2.5-.4.7-.9.7h-.4v.9h.5z" fill="#fff"/></svg>
          </div>
        </div>
      </section>
